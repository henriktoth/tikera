...
function MovieDetailsCard(props){
    ...
    return (
        <div className="bg-neutral-800/50 flex h-85 p-3 rounded-xl w-150">
                ...
                <div className="">
                    ...
                    <div className="flex flex-wrap gap-2 mt-3">
                        {showTimes.map(showtime => (
                            <div key={showtime} className="bg-gradient-to-r from-indigo-900 to-indigo-800 px-3 py-2 rounded-lg text-center text-white hover:cursor-pointer">
                                {showtime}
                            </div>
                        ))}
                    </div>
